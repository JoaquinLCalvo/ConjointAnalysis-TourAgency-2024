...
This package was chosen as the reference based on results from the models we fitted earlier. It serves as a benchmark for comparing and evaluating other packages, ensuring consistency in interpreting the model outputs.

The analysis indicates that price and accommodation quality are critical factors influencing customer preferences, with affordable options paired with premium accommodations performing the best. Portugal emerges as the most preferred destination, consistently attracting higher preference shares. Packages that achieve a balance between cost, comfort, and convenience tend to be the most appealing. In contrast, adjustments such as switching transport modes from plane to bus, lowering accommodation quality, or increasing prices significantly reduce preference shares.
...
Portugal stands out as the most attractive destination, increasing the Preference Share (PS) by approximately 0.5%. Spain, while reducing market share by 12.3%, remains somewhat competitive. In contrast, Turkey and Greece reduce market share by larger margins (26.3% and 28.8%, respectively) making them less preferred destinations.

In terms of transportation, traveling by plane slightly increases market share by 0.3%, making it the most preferred option. Bus travel reduces market share by 12.8%, reflecting moderate aversion, while train travel decreases market share by 22.2%, indicating it is the least preferred mode of transport.

For accommodations, 5-star options slightly increase market share by 0.7%, demonstrating a preference for premium offerings. Conversely, 3-star accommodations reduce market share by 23.7%, suggesting that mid-tier options are not competitive. Budget accommodations decrease market share by 31.1%, indicating they are highly unattractive.

Regarding trip duration, a 2-day trip slightly increases market share by 0.5%, making it the most appealing choice. A 10-day trip reduces market share by 19.7%, signaling that longer durations are less desirable, while a 5-day trip decreases market share by 26.9%, making it the least favorable duration.

Finally, price has a significant influence. A price of 500 increases market share by 10.2%, indicating that lower pricing strongly enhances attractiveness. A price of 800 results in a minimal decrease of 0.3%, suggesting it is near the optimal price point. A mid-range price of 1500 reduces market share by 10.2%, showing moderate sensitivity, while the highest price option, 2500, reduces market share by 20.3%, highlighting that higher prices significantly deter preferences.
...
barplot(tradeoff1$increase, horiz = FALSE, names.arg = tradeoff1$labels, las = 2, 
        ylab = "Change in Share for the Planned Product Design", 
        ylim = c(-0.3, 0.12), cex.names = 0.7)
grid(nx = NA, ny = NULL)
